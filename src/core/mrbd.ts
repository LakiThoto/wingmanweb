// Meta Ray-Ban Display (MRBD) document setup — wearables.developer.meta.com/docs/develop/webapps/build
...
export function applyMrbdDocument(mode: Mode): void {
...
export function detectModeFromLocation(): Mode {
  const params = new URLSearchParams(location.search);
  if (params.get('mode') === 'glasses') return 'glasses';
