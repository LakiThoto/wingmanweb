...
export const STRINGS: Record<string, string> = {
  ...
  'menu.custom.title':        'Custom instellingen',
  'menu.custom.audio':        'Audio',
  'menu.custom.support':      'Support',
  'menu.custom.voice':        'Voice',
  'menu.custom.gesture_hint': 'Draai je hand als bij volume om support aan te passen (↑↓ in lab)',
  'menu.custom.save':         'Opslaan',
  ...
  // ── navigation (drive / walk) ─────────────────────────────────────────
  'audio.transition':               'Volgende stop.',
  'audio.transition.beginner':      'We gaan naar de volgende stop.',
  'audio.transition.experienced':   'Volgende stop.',
  'audio.transition.pro':           '',
  'audio.transition.locker_route':        'Naar PostNL Punt.',
  'audio.transition.locker_route.beginner': 'Even rust. Daarna naar het PostNL Punt.',
  'audio.transition.locker_route.experienced': 'Rijd naar PostNL Punt.',
  'audio.transition.locker_route.pro':    '',

  'drive.start':                    'Stop {n}. Rijd naar {addr}.',
  'drive.start.beginner':           'Stop {n} op de route. Rijd nu naar {addr}.',
  'drive.start.experienced':        'Stop {n}. {addr}.',
  'drive.start.pro':                'Stop {n}.',

  'drive.hint':                     'Rijd naar de stop. GPS bepaalt wanneer je kunt parkeren.',
  'drive.audio.title':              'Audiobegeleiding',
  'drive.audio.sub':                'Navigatie actief',
  'drive.audio.aria':               'Audiobegeleiding, navigatie actief',
  'drive.card.title':               'Volgende stop',
  'drive.card.stop_prefix':         'Stop',
  'drive.voice_prefix':             'Luister of tik ',
  'drive.voice_em':                 '"doorgaan"',

  'walk.start':                     'Loop naar het adres.',
  'walk.start.beginner':            'Loop nu naar het afleveradres. Ik houd de afstand bij.',
  'walk.start.experienced':         'Loop naar adres.',
  'walk.start.pro':                 '',

  'walk.approaching':               'Je bent er bijna.',
  'walk.approaching.beginner':      'Bijna op de bestemming. Nog even doorlopen.',
  'walk.approaching.experienced':   'Bijna daar.',
  'walk.approaching.pro':           '',

  'walk.arrival':                   'Je bent aangekomen. Lever het pakket af.',
  'walk.arrival.beginner':          'Aangekomen op het adres. Tik op bezorgen als je voor de deur staat.',
  'walk.arrival.experienced':       'Aangekomen.',
  'walk.arrival.pro':               'Locatie.',

  'walk.map.label':                 'Kaart navigatie',
  'walk.hud.chip':                  'Pakket afleveren',
  'walk.hud.stats_label':           'Aflevergegevens',
  'walk.hud.hint_label':            'Hint',
  'walk.hud.amount_label':          'Aantal',
  'walk.hud.floor_default':         '2e verdieping',
  'walk.hud.approaching':           'Bijna daar',
  'walk.hud.arrived':               'Aangekomen',
  'walk.hud.notice_dog':            'Hond aanwezig op adres',
  ...
  'zoek.confirmed.label':     'Bevestigd',
  'zoek.confirmed.aria':      'Pakket bevestigd in de bus',
  ...
  'feedback.locker.scheduled':      'Onthouden voor PostNL Punt na je laatste stop.',
  'feedback.locker.scheduled.beginner': 'Ik onthoud dit pakket. Na je laatste stop ga je naar het PostNL Punt.',
  'feedback.locker.scheduled.experienced': 'PostNL Punt na de route.',
  'feedback.locker.scheduled.pro':  'Punt na route.',

  'voice.locker.route_break':             'Je laatste stop is afgerond. Rijd daarna naar het PostNL Punt om {n} pakketten af te geven.',
  'voice.locker.route_break.beginner':    'Goed gedaan — je laatste stop is afgerond. Even rust. Daarna navigeer je naar {name} om {n} pakketten in de parcel locker te plaatsen.',
  'voice.locker.route_break.experienced': 'Laatste stop klaar. Rijd naar {name} voor {n} pakketten in de locker.',
  'voice.locker.route_break.pro':         'Naar PostNL Punt. {n} locker.',
  ...
  'locker.place.chip':              'Plaatsen in locker',
  'locker.place.grid_title':        'Plaatsen',
  'locker.place.size':              '2M',
  'locker.place.sub':               'Leg het pakket in het locker-vak en scan daarna de barcode op het label.',
  'locker.btn.navigate':            'Bevestigd',
